...
namespace DevFuel.NAnt.Tasks
{
    ...
    /// Extended by devfuel
	/// </summary>
	[TaskName("googlecodeupload")]
	public class GoogleCodeUploadTask : Task
	{
		...
		internal void Upload()
		{
			...
			request.UserAgent = String.Concat("DevFuel.NAnt.Tasks-", Assembly.GetExecutingAssembly().GetName().Version.ToString());
